...
(cl:defmethod cl:initialize-instance :after ((m <Servo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name servo_array_driver-msg:<Servo> is deprecated: use servo_array_driver-msg:Servo instead.")))

(cl:ensure-generic-function 'servo-val :lambda-list '(m))
(cl:defmethod servo-val ((m <Servo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_array_driver-msg:servo-val is deprecated.  Use servo_array_driver-msg:servo instead.")
  (servo m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <Servo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_array_driver-msg:value-val is deprecated.  Use servo_array_driver-msg:value instead.")
  (value m))
