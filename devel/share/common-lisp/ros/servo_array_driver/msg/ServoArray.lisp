...
(cl:defclass <ServoArray> (roslisp-msg-protocol:ros-message)
  ((servos
    :reader servos
    :initarg :servos
    :type (cl:vector servo_array_driver-msg:Servo)
   :initform (cl:make-array 0 :element-type 'servo_array_driver-msg:Servo :initial-element (cl:make-instance 'servo_array_driver-msg:Servo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ServoArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name servo_array_driver-msg:<ServoArray> is deprecated: use servo_array_driver-msg:ServoArray instead.")))

(cl:ensure-generic-function 'servos-val :lambda-list '(m))
(cl:defmethod servos-val ((m <ServoArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_array_driver-msg:servos-val is deprecated.  Use servo_array_driver-msg:servos instead.")
  (servos m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ServoArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'servos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'servo_array_driver-msg:Servo))
