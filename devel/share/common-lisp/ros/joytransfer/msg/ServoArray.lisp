...
(cl:defclass <ServoArray> (roslisp-msg-protocol:ros-message)
  ((servos
    :reader servos
    :initarg :servos
    :type (cl:vector joytransfer-msg:Servo)
   :initform (cl:make-array 0 :element-type 'joytransfer-msg:Servo :initial-element (cl:make-instance 'joytransfer-msg:Servo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ServoArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name joytransfer-msg:<ServoArray> is deprecated: use joytransfer-msg:ServoArray instead.")))

(cl:ensure-generic-function 'servos-val :lambda-list '(m))
(cl:defmethod servos-val ((m <ServoArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader joytransfer-msg:servos-val is deprecated.  Use joytransfer-msg:servos instead.")
  (servos m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ServoArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'servos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'joytransfer-msg:Servo))
